...
clear all
close all
Image_Transformmer = Read_Raw_('cowboy.raw',500,500);
...
Diamond_Red_Plane = pentagon_final_warp_friday(Image_Transformmer(:,:,1));
Diamond_Green_Plane = pentagon_final_warp_friday(Image_Transformmer(:,:,2));
Diamond_Blue_Plane = pentagon_final_warp_friday(Image_Transformmer(:,:,3));
...
%  %%%%%%%%%%%%%UNWARPING via FORWARD MAPPING%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 reverse_red_plane= reverse_pentagon_final(Diamond_Red_Plane);
 reverse_green_plane=reverse_pentagon_final(Diamond_Green_Plane);
 reverse_blue_plane=reverse_pentagon_final(Diamond_Blue_Plane);
