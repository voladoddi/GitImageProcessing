function AF = average_filter(colour_channel)
...
%------------------------FILTERING ACTION--------------------------
filter_window=ones(3); %setting the weights of the window.
...
fil_output_2d(i,j)=sum/9; %replacing the pixels with the average of the neighbourhood pixels in window 
sum=0;
    end
end
