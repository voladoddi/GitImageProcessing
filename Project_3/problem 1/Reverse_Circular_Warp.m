function Image = Reverse_Circular_Warp(In_Image)
...
A = [1 U(1) V(1) U(1)*U(1) U(1) * V(1) V(1)*V(1) ;...
     1 U(2) V(2) U(2)*U(2) U(2) * V(2) V(2)*V(2) ;...
     1 U(3) V(3) U(3)*U(3) U(3) * V(3) V(3)*V(3) ;...
     1 U(4) V(4) U(4)*U(4) U(4) * V(4) V(4)*V(4) ;...
     1 U(5) V(5) U(5)*U(5) U(5) * V(5) V(5)*V(5) ;...
     1 U(6) V(6) U(6)*U(6) U(6) * V(6) V(6)*V(6) ];
