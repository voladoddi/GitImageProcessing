function tp = triangle_warp2(image,matrix_A, matrix_U,matrix_V,output_img)



input_image= image;
x_size =size(input_image,1);
y_size=size(input_image,2);
ch_size=size(input_image,3);
...
%deleted x_ and y_ 
              ...
              ydash = floor(y_dash) ;
                ...
                if( xdash > 0 && xdash < x_size && ydash > 0 && ydash < y_size)
